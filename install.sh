...
EOF
    ...
    curl -o /usr/bin/V2bX -Ls https://github.com/RandomNessan/v2bx_install_oneclick/blob/main/V2bX.sh
    ...
    if [[ $first_install == true ]]; then
        ...
        if [[ $if_generate == [Yy] ]]; then
            curl -o ./initconfig.sh -Ls https://github.com/RandomNessan/v2bx_install_oneclick/blob/main/initconfig.sh
